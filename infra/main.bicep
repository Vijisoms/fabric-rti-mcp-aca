...
module mcp './app/mcp.bicep' = {
  ...
  params: {
    ...
    appSettings: {
        ...
        KUSTO_KNOWN_SERVICES: '[{"service_uri":"https://trd-ggxwe88hdxqhnacwry.z8.kusto.fabric.microsoft.com","default_database":"ehrtimcp_new","description":"EHRTI MCP Kusto Cluster","use_ingestion_endpoint":true}]'
        AZURE_CLIENT_ID: mcpUserAssignedIdentity.outputs.clientId  // For DefaultAzureCredential to use the managed identity
    }
